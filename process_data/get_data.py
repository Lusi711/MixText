...
def constituency_parsing(args):
    ...
    for dataset in args.data:
        ...
        for i, text_name in enumerate(task_to_keys[dataset]):
            ...
            # train[parsing_name] = train[text_name].parallel_apply(parsing_stanfordnlp)
            train[parsing_name] = [parsing_stanfordnlp(text) for text in train[text_name]]
...
def download_data(args):
    for dataset in args.data:
        ...
        try:
            ...
            elif dataset in ['sst2', 'rte', 'mrpc', 'qqp', 'mnli', 'qnli']:
            ...
            if not os.path.exists(path_dir):
                if dataset == 'trec':
                    ...
                    os.makedirs(os.path.join(path_dir, 'runs/label-coarse/raw'))
                    os.makedirs(os.path.join(path_dir, 'runs/label-coarse/aug'))
                    os.makedirs(os.path.join(path_dir, 'runs/label-coarse/raw_aug'))
                    os.makedirs(os.path.join(path_dir, 'runs/label-fine/raw'))
                    os.makedirs(os.path.join(path_dir, 'runs/label-fine/aug'))
                    os.makedirs(os.path.join(path_dir, 'runs/label-fine/raw_aug'))
                else:
...
if __name__ == '__main__':
    ...
    task_to_keys = task_settings.task_to_keys
